...
RUN mkdir -p /opt/eagle-7.4.0
RUN chown user:user /opt/eagle-7.4.0
...
RUN wget -q -O eagle-lin64-7.4.0.run http://web.cadsoft.de/ftp/eagle/program/7.4/eagle-lin64-7.4.0.run
RUN chmod 755 eagle-lin64-7.4.0.run
RUN ./eagle-lin64-7.4.0.run /opt
RUN rm eagle-lin64-7.4.0.run
